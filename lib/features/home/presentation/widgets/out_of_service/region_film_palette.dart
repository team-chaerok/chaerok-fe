...
extension RegionFilmPalette on RegionCode {
  ...
  Color get filmTabColor => switch (this) {
    ...
    RegionCode.yesan => const Color(0xFF324D3E),
    // 갯벌·노을 — 딥 틸.
    RegionCode.seosan => const Color(0xFF2E4A4E),
    // 궁남지 연꽃 — 다크 플럼.
    RegionCode.buyeo => const Color(0xFF43354A),
    // 백제 왕도 — 다크 엄버.
    RegionCode.gongju => const Color(0xFF4E3D2C),
  };
