...
extension RegionFilmPalette on RegionCode {
  ...
  /// 탭 라벨 색 강제 지정. null이면 [FolderCard] 기본값(흰색)을 쓴다.
  /// 예산만 [filmTabColor]가 밝아서 어두운 라벨로 뒤집는다.
  Color? get filmLabelColor => switch (this) {
    RegionCode.yesan => const Color(0xFF45523D),
    RegionCode.gongju || RegionCode.buyeo || RegionCode.seosan => null,
  };
